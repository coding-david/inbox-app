  ...
  return (
    <div className="row toolbar">
      <div className="col-md-12">
        ...
        <a className="btn btn-danger" onClick={showFormToggleHandler}>
        ...
        <button
          ...
          onClick={() => unreadOrReadSelectedMes(true)}
        ...
        <button
          className="btn btn-default"
          onClick={() => unreadOrReadSelectedMes(false)}
          disabled={!nothingSelected()}
        >
          Mark As Unread
        </button>
